...
# def remove_noise(
#     audio: AudioType, output_path: Optional[str] = None
...
# def text_to_speech(
#     text: str, output_path: Optional[str] = None, speaker: str = "v2/en_speaker_6"
# ) -> Union[np.ndarray, str]:
#     """
...
#     config: ConfigDict, encoder_path: Optional[str], decoder_path: Optional[str]
# ) -> Tuple[str, str]:
#     """
...
#         default_encoder = config.get(
#             "encoder_path", "models/whisper/WhisperEncoder.onnx"
#         )
#         encoder_path = (
#             os.path.join(os.path.dirname(os.path.dirname(__file__)), default_encoder)
#             if not os.path.isabs(default_encoder)
#             else default_encoder
#         )

#     if decoder_path is None:
#         default_decoder = config.get(
#             "decoder_path", "models/whisper/WhisperDecoder.onnx"
#         )
#         decoder_path = (
#             os.path.join(os.path.dirname(os.path.dirname(__file__)), default_decoder)
#             if not os.path.isabs(default_decoder)
#             else default_decoder
#         )
...
#     try:
#         config = _load_config()
#         encoder_path, decoder_path = _get_model_paths(
#             config, encoder_path, decoder_path
#         )
...
#             audio_data, target_sample_rate, chunk_duration
#         )
...
#     parser.add_argument(
#         "--input", required=True, help="Input audio file path or text for TTS"
#     )
#     parser.add_argument(
#         "--output",
#         help="Output file path (audio file for TTS/noise removal, SRT file for transcription)",
#     )
#     parser.add_argument(
#         "--task",
#         choices=[
...
#     )
#     parser.add_argument(
#         "--speaker", default="v2/en_speaker_6", help="Speaker voice for TTS"
#     )
...
#         help="Audio chunk duration for transcription",
#     )
...
#                 args.input, args.encoder_path, args.decoder_path
#             )
